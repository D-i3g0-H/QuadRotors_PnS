...
%[text] ## SPECIFY WHICH REFERENCES TO INCLUDE AND THEIR SIGNAL PROPERTIES
%[text] The following three variables specify which of the reference signal types should be included. If multiple types are "turned-on" then teh reference signals are simply summed together. Each of these should be set to {'on','yes'} or {'off,'no'}
...
%%
%[text] ## SPECIFY THE DETAILS OF THE DIFFERENT REFERENCE SIGNALS
%[text] The variables in this section speficy the properties of each of the reference signal types.
%[text] ### Degrees to radians conversion
deg2rad = pi/180;
rad2deg = 180/pi;
%[text] ### STEP CHANGE REFERENCE:
...
%[text] ### SINUSOID REFERENCE SIGNAL:
