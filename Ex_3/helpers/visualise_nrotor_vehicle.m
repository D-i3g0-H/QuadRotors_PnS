...
% Plot all the lines
h_frame_lines = line( h_axes , frame_lines_x , frame_lines_y );
...
CoG_radius = 0.15 * min( inter_rotor_distance_nearest_neighbour(:,1) );
...
% Draw a circlearound the outside of the Center of Gravity symbolh_frame_geometrical_center = rectangle(...
